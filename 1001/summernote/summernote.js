...
(function (factory) {
  ...
  var Context = function ($note, options) {
    ...
    this.disable = function (forExport = false) {
  ...
  var ui = {
    ...
    toggleBtn: function ($btn, isEnable) {
      ...
      // $btn.layoutInfo.toolbar[0].childern[0].attr('disabled', !isEnable);
    },
  ...
  var Buttons = function (context) {
    ...
    var options = context.options;
    var lang = options.langInfo;
    var dataxx = context.layoutInfo.editable
    ...
    var word = ui.button({
      ...
      tooltip: 'Export to *docx File',
      click: function(e) {
        // console.log(e)
        context.createInvokeHandler('editor.word');
        context.triggerEvent('export', {from: 'doc', data: dataxx.html()});
      }
    });

    var pdf = ui.button({
      contents: '<i class="fa fa-file-pdf-o"></i>',
      tooltip: 'Expor to *pdf File',
      click: function(e) {
        context.createInvokeHandler('editor.pdf');
        context.triggerEvent('export', {from: 'pdf', data: dataxx.html()});
      }
    });

    context.memo('button.word', func.invoke(word, 'render'));
    context.memo('button.pdf', func.invoke(pdf, 'render'));

    context.memo('button.print', function () {
      return ui.buttonGroup([
        ui.button({
          className: 'dropdown-toggle',
          contents: '<i class="fa fa-print"></i> <span class="note-icon-caret"></span>',//ui.icon(options.icons.print) + ' ' + ui.icon(options.icons.caret, 'span'),
        ...
        //   items: options.print,
        //   checkClassName: options.icons.menuCheck,
        //   className: 'dropdown-print',
        //   click: context.createInvokeHandler('editor.print')
        // })
        ui.dropdown([
          ui.buttonGroup({
            className: 'note-align',
